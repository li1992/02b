...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="/login/login">登录</a>&nbsp; <a href="/login/regist" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
        	<div class="un_login">还未登录！<a href="/login/login" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            	<li>
...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
                <?php foreach ($data['notice'] as $key => $v): ?>
                    <li><span>[ 公告 ]</span><a href="#"><?php echo $v['title'] ?></a></li>
                <?php endforeach ?>
            </ul>
            <div class="charge_t">
