		...
		<div class="pageTop">
			<div class="page">
				<img src="/public/img/coin02.png" /><span><a href="/public/#">首页</a>&nbsp;-&nbsp;<a
					href="/public/#">公共管理</a>&nbsp;-</span>&nbsp;修改密码
			</div>
		</div>
		<div class="page ">
			<!-- 修改密码页面样式 -->
			<div class="bacen">
				<form action="/admin/update_pwd_do" method="post">
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						 name="oldpwd" /> <img class="imga"
						src="/public/img/ok.png" /><img class="imgb" src="/public/img/no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" 
						id="pwd3" name="qpwd" /> <img class="imga" src="/public/img/ok.png" /><img
						class="imgb" src="/public/img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
