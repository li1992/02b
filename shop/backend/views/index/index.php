...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="/public/inc/head.php?admin_name=<?php echo $admin_name; ?>"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="/public/inc/left.php" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="/public/picture.php" name="main" scrolling="yes" noresize="noresize"
