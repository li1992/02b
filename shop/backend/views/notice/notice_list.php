...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="/notice/notice_add">上传公告&nbsp;&nbsp;+</a>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="cfD" style="display:inline-block">
					<input class="addUser" id="search" type="text" placeholder="输入公告名/ID" />
				...
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="450px" class="tdColor">内容</td>
						...
						<?php foreach ($data['res'] as $key => $v): ?>
							...
							<td><a href="/notice/update_notice?id=<?php echo $v['id'] ?>"><img class="operation"
		...
		$.ajax({
				...
				success:function(data){
					...
					$.each(data.res,function(k,v){
						...
						tr.append('<td><a href="/notice/update_notice?id='+v.id+'" id="upd"><img class="operation" src="/public/img/update.png"></a></td>');
						$("#tbody").append(tr);
					})
					$('#page').html(data.page);
